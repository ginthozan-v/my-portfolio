              ...
              <DialogPanel className="w-screen h-[45vh] md:h-[70vh] rounded-t-3xl border-t-2 border-white bg-white/5 p-6 backdrop-blur-xl">
                ...
                <div className="mt-5 md:mt-20 flex items-center gap-1 overflow-scroll scroll-smooth snap-x">
                  {modalData?.map((data: any) => (
                    <div
                      key={data.title}
                      className="group snap-center h-full min-w-[20rem] md:min-w-[40rem] max-w-[20rem] md:max-w-[40rem] rounded-md border border-black/20 overflow-hidden relative p-8"
                    >
                      ...
                      <Image
                        ...
                        height="1080"
                        alt="project"
                        className="w-full h-full object-contain rounded-md group-hover:scale-105 duration-500 transition-all ease-out"
                        placeholder="blur"
